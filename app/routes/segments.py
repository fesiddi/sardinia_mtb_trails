...
@router.get("/segments", tags=["segments"], summary="Get all segments", response_model=list[EnhancedSegment])
async def segments(
...
@router.get("/segments/{location}", tags=["segments"], response_model=list[EnhancedSegment])
